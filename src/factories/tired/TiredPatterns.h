...
constexpr PatternStep kTiredStabsSteps[] = {
    CHORD_PATTERN(D2), CHORD_PATTERN(Ad1), CHORD_PATTERN(G1),
    CHORD(D2), _NO_STEP, _NO_STEP, CHORD(D2),
    _NO_STEP, _NO_STEP, CHORD(D2), _NO_STEP,
    _NO_STEP, CHORD(D1), _NO_STEP, _NO_STEP,
    CHORD(D1), _NO_STEP, CHORD(D1), _NO_STEP
};
